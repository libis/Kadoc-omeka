    ...
    <div id="content" class='container' role="main" tabindex="-1">
      <div class="row">
        <div class="co col-md-6 col-sm-6 col-lg-4">
          <a class="block-link" href="<?php echo url("exhibits")."?featured=0";?>"><h2><?php echo __('Exhibits');?></h2></a>
            <div class="col-content">
              <a class="block-link" href="<?php echo url("exhibits")."?featured=0";?>"><img src="<?php echo img('placeholder3.jpg');?>"></a>
              <div class="summary">
        ...
        <div class="co col-sm-6 col-md-6 col-lg-4">
          <a class="block-link" href="<?php echo url("collections")."?featured=no";?>"><h2><?php echo __('Collections');?></h2></a>
            <div class="col-content">
              <a class="block-link" href="<?php echo url("collections")."?featured=no";?>"><img src="<?php echo img('placeholder2.jpg');?>"></a>
              <div class="summary">
        ...
        <div class="co col-md-6 col-sm-6 col-lg-4">
          <a class="block-link" href="<?php echo url("items")."?featured=no";?>"><h2>Erfgoed in de kijker</h2></a>
            <div class="col-content">
              <a class="block-link" href="<?php echo url("items")."?featured=no";?>"><img src="<?php echo img('placeholder1.jpg');?>"></a>
              <div class="summary">
